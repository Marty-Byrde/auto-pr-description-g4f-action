...
def update_pr_description(github_token, context, pr_number, generated_description):
    ...
    new_description = f"""> Automatically generated by [auto-pr-description](https://github.com/Marty-Byrde/auto-pr-description-g4f-action)
\n{generated_description}
"""

    try:
        if current_description and not current_description.startswith('> Automatically generated by'):
